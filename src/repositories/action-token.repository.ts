...
export class ActionTokenRepository {
    ...
    public async findOne(params: FilterQuery<IActionToken>): Promise<IActionToken | null> {
    ...
    public async deleteManyByUserIdType(userId: string, type: EActionTokenType): Promise<void> {
